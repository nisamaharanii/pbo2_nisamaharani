...
akun_ku = JointAccount('12345678', 'Rp. 1.500.000,00', '10%', 'Sucipto Atmaja')
print('Nomor akun\t:', akun_ku.get_nomor_akun())
print('Saldo\t\t:', akun_ku.get_saldo())
print('Presentase bunga:', akun_ku.get_persentase_bunga())
print('Owner\t\t:', akun_ku.get_owners())
